...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield templater.generateToFile('hue.gl-rgb-map.scss.jinja', path.join(CONFIG.path.src, 'scss', 'hue', '_hue.gl-rgb-map.scss'));
            yield templater.generateToFile('hue.gl-rgb-var.scss.jinja', path.join(CONFIG.path.src, 'scss', 'hue', '_hue.gl-rgb-var.scss'));
            yield templater.generateToFile('hue.gl-hcl-map.scss.jinja', path.join(CONFIG.path.src, 'scss', 'hue', '_hue.gl-hcl-map.scss'));

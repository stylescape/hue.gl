...
var rgb2cmyk = function(r: number, g: number, b: number, normalized: any){
    var c = 1 - (r / 255);
    var m = 1 - (g / 255);
    var y = 1 - (b / 255);
...
function colorToHex(color: { toString: (arg0: number) => any; }) {
...
function pad(num: string | any[], size: number, char: any) {
    num = num.toString();
